                        ...
                        data={[
                          {
                            ...
                            y: modelDetailHistory['accuracy'],
                            mode: 'lines',
                            name: 'train',
                          },
                          {
                            x: Array.from({ length: 101 }, (x, i) => i),
                            y: modelDetailHistory['val_accuracy'],
                            mode: 'lines',
                            name: 'validation',
                          },
                        ]}
                    ...
                    <div className='col-md-6 chart-container'>
                      <Plot
                        data={[
                          {
                            x: Array.from({ length: 101 }, (x, i) => i),
                            y: modelDetailHistory['loss'],
                            mode: 'lines',
                            name: 'train',
                          },
                          {
                            x: Array.from({ length: 101 }, (x, i) => i),
                            y: modelDetailHistory['val_loss'],
                            mode: 'lines',
                            name: 'validation',
                          },
                        ]}
                                ...
                                datasets: [
                                  {
                                    data: modelDetail?.datasets?.map(
                                      (dataset) => dataset.quantity / total,
                                    ),
