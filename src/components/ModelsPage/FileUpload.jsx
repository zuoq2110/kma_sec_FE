...
export function FileUploadDataset({
  maxFileSize,
  progress,
  uploadHandler,
  onClear,
  ...
  const emptyTemplate = () => {
    ...
    return (
      ...
      >
        ...
        <h3 className="my-3">Drag and Drop files here</h3>
        <p className="mb-3">( The file name format is name_label.apk)</p>
      </div>
    );
  };
      ...
      <>
        <div className="flex align-items-center flex-wrap">
          <div className="flex align-items-center" style={{ width: "60%" }}>
            <span
              className="flex flex-column text-left ml-3 sm:max-w-full sm:break-normal"
  ...
  const onSelect = (e) => {
    const fileList = Array.from(e.files || []);
